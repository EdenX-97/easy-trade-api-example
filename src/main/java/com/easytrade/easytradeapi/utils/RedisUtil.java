 ...
 * @Author: Mo Xu
 * @Date: 2021-11-13 21:02:33
 * @LastEditors: Mo Xu
 * @LastEditTime: 2021-12-31 18:17:30
 * @FilePath: /EasyBuyCar/src/main/java/com/jiandanmaiche/api/utils/RedisUtil.java
 */
...
public class RedisUtil {
	...
	/**
	 * StringRedisTemplate默认采用的是String的序列化策略, RedisTemplate默认采用的是JDK的序列化策略，保存的key和value都是采用此策略序列化保存的
	 */
	@Autowired
